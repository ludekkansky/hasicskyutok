...
[TestClass]
public sealed class TestyVysledkyUtok
{
    [TestMethod]
    public void TestMethodObaPlatneLepsiDruhy()
    {
        var vysledek = new HasicskyUtok.Models.VysledekUtok
        {
            Cas1 = new TimeOnly(0, 1, 10),
            NeplatnyPokus1 = false,
            Cas2 = new TimeOnly(0, 1, 20),
            NeplatnyPokus2 = false,
            Druzstvo = new HasicskyUtok.Models.Druzstvo { ID = 1, Nazev = "Druzstvo 1", },
        };
        Assert.IsNotNull(vysledek);
        var vysledek2 = new HasicskyUtok.Models.VysledekUtok
        {
            Cas1 = new TimeOnly(0, 1, 9),
            NeplatnyPokus1 = false,
            Cas2 = new TimeOnly(0, 1, 8),
            NeplatnyPokus2 = false,
    ...
    public void TestMethodObaPlatneLepsiPrvni()
    {
        var vysledek = new HasicskyUtok.Models.VysledekUtok
        {
            Cas1 = new TimeOnly(0, 1, 7),
            NeplatnyPokus1 = false,
            Cas2 = new TimeOnly(0, 1, 6),
            NeplatnyPokus2 = false,
            Druzstvo = new HasicskyUtok.Models.Druzstvo { ID = 1, Nazev = "Druzstvo 1", },
        };
        Assert.IsNotNull(vysledek);
