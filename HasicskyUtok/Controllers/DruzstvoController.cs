...
namespace HasicskyUtok.Controllers
{
    ...
    public class DruzstvoController : Controller
    {
        ...
        {
            var hasicskyutokDbContext = _context.Druzstva.Include(d => d.Kategorie).Include(s=>s.Stafeta);
        ...
        public IActionResult Create()
        {
            ...
            ViewData["StafetaID"] = new SelectList(_context.Stafeta, "ID", "NazevStafety");
        ...
        public async Task<IActionResult> Create([Bind("ID,Nazev,StartovniCislo,KategorieID,StafetaID")] Druzstvo druzstvo)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("ID,Nazev,StartovniCislo,KategorieID,StafetaID")] Druzstvo druzstvo)
        {
            if (id != druzstvo.ID)
            {
                return NotFound();
